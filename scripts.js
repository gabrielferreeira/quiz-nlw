const perguntas = [
  ...
  {
      pergunta: "Qual é o nome do tipo de exercício que trabalha um único grupo muscular?",
      respostas: [
          "Exercício composto",
  ...
  {
      pergunta: "Qual é a melhor abordagem para evitar lesões durante a musculação?",
      respostas: [
  ...
  {
      pergunta: "Qual é a função principal da creatina na suplementação esportiva?",
      respostas: [
          "Aumentar a resistência aeróbica",
  ...
  {
      pergunta: "Quanto tempo, em média, deve durar um treino de musculação para obter resultados eficazes?",
      respostas: [
          "30 minutos",
          "1 hora",
          "90 minutos",
  ...
  {
      pergunta: "Qual é o principal benefício da realização de exercícios de resistência?",
      respostas: [
  ...
  {
      pergunta: "Qual é o nome do processo pelo qual os músculos crescem após o treinamento de musculação?",
      respostas: [
          "Hipertrofia",
          "Atrofia",
          "Regeneração",
  ...
  {
      pergunta: "Qual é o músculo do peito frequentemente trabalhado através de exercícios como supino?",
      respostas: [
          "Bíceps",
          "Quadríceps",
          "Peitoral",
  ...
  {
      pergunta: "Qual é a melhor maneira de aumentar a intensidade do treino de musculação?",
      respostas: [
  ...
  {
      pergunta: "Qual é o nome do processo pelo qual o corpo queima calorias para produzir energia durante o exercício?",
      respostas: [
          "Catabolismo",
          "Metabolismo",
          "Termogênese",
